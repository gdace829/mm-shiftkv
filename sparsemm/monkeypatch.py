...
# # from transformers import models.qwen2_vl.modeling_qwen2_vl.Qwen2VLFlashAttention2
...
from sparsemm.qwen_model import qwen_flash_attn2_forward_AdaKV, qwen_flash_attn2_forward_PyramidKV, qwen_flash_attn2_forward_SnapKV, \
                                qwen_flash_attn2_forward_SparseMM, qwen_flash_attn2_forward_Mask,qwen_flash_attn2_forward_ShiftKV,qwen_flash_attn2_forward_keydiff,qwen_flash_attn2_forward_streamingllm,qwen_flash_attn2_forward_ExpectedAttention
...
def replace_llama(method):
    ...
    if method == "snapkv":
        ...
        print("Using SparseMM!")# 前向传播时动态的llama LlamaDecoderLayer
        ...
        print("Using SparseMM_query!")# 前向传播时动态的llama
        transformers.models.llama.modeling_llama.LlamaModel.forward = adaptive_LlamaModel_forward
...
def replace_qwen(method):
    ...
    if method == 'keydiff':
        ...
        # transformers.models.qwen2_5_vl.modeling_qwen2_5_vl.Qwen2_5_VLFlashAttention2.forward=forward
        # transformers.models.qwen2_5_vl.modeling_qwen2_5_vl.Qwen2_5_VLFlashAttention2.forward =  qwen_flash_attn2_forward_SparseMM_query
        # transformers.models.qwen2_5_vl.modeling_qwen2_5_vl.Qwen2_5_VLForConditionalGeneration.forward = forwardllm
    ...
    if method == "adakv":
        ...
        print("Using shiftkv!")# 前向传播时动态的llama
